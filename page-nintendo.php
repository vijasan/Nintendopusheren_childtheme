    ...
    <section id="primary" class="content-area spil entry">
        ...
        <script>
            ...
            async function getJson() {
                ...
                const url = "https://vijasan.dk/kea/10_eksamen/nintendopusheren/wp-json/wp/v2/nintendo?per_page=100";
            ...
            function displayGames() {
                ...
                nintendo.forEach(nintendo => {
                    ...
                    clone.querySelector(".spil-title").textContent = nintendo.title.rendered;
                    clone.querySelector(".pris").textContent = nintendo.pris;
                    clone.querySelector(".konsol").textContent = nintendo.konsol;
                    clone.querySelector(".emballage").textContent = nintendo.emballage + " emballage";
                    clone.querySelector(".picture").src = nintendo.billede;
                    clone.querySelector(".picture").alt = nintendo.billednavn;
                    clone.querySelector(".spil-container").addEventListener("click", () => visDetaljer(nintendo));
                    liste.appendChild(clone);
                });
            }

            function visDetaljer(nintendo) {
                popup.style.display = "flex";
                popup.querySelector(".spil-title").textContent = nintendo.title.rendered;
                popup.querySelector(".pris").textContent = nintendo.pris;
                popup.querySelector(".konsol").textContent = nintendo.konsol;
                popup.querySelector(".emballage").textContent = nintendo.emballage + " emballage";
                popup.querySelector(".picture").src = nintendo.billede;
                popup.querySelector(".picture").alt = nintendo.billednavn;
            }
